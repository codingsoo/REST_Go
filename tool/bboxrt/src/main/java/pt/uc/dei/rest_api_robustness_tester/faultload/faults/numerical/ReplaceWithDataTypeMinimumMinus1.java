...
public class ReplaceWithDataTypeMinimumMinus1 implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with data type minimum - 1";
    }
    ...
    public String Inject(String valueRepresentation, SchemaBuilder schema)
    {
        try
        {
            ...
            BigInteger bigValue = new BigInteger("" + Integer.MIN_VALUE);
        ...
        try
        {
            ...
            BigDecimal bigValue = new BigDecimal("" + Float.MIN_VALUE);
        ...
        try
        {
            ...
            BigInteger bigValue = new BigInteger("" + Long.MIN_VALUE);
            return "" + bigValue.subtract(BigInteger.ONE);
        }
        catch(Exception ignored) {}
        ...
        try
        {
            ...
            BigDecimal bigValue = new BigDecimal("" + Double.MIN_VALUE);
            return "" + bigValue.subtract(BigDecimal.ONE);
        }
        catch(Exception ignored) {}
