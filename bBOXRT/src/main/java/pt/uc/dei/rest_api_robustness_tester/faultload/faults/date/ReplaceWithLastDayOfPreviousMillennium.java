...
public class ReplaceWithLastDayOfPreviousMillennium implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with the last day of the previous millennium";
    }
    ...
    public String Inject(String value, SchemaBuilder schema)
    {
        try
        {
            ...
            dateTime = dateTime.withDate(1999, 12, 31);
