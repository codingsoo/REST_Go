...
public class ReplaceWithRandomNonPrintableCharacterString implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with random non-printable character string of equal length";
    }
    ...
    {
        return Utils.RandomString(Utils.AsciiNonPrintableCharacters(), value.length());
    }
}
