...
public class ReplaceWithDataTypeMaximumPlus1 implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with data type maximum + 1";
    }
    ...
    public String Inject(String valueRepresentation, SchemaBuilder schema)
    {
        try
        {
            ...
            BigInteger bigValue = new BigInteger("" + Integer.MAX_VALUE);
        ...
        try
        {
            ...
            BigDecimal bigValue = new BigDecimal("" + Float.MAX_VALUE);
        ...
        try
        {
            ...
            BigInteger bigValue = new BigInteger("" + Long.MAX_VALUE);
            return "" + bigValue.add(BigInteger.ONE);
        }
        catch(Exception ignored) {}
        ...
        try
        {
            ...
            BigDecimal bigValue = new BigDecimal("" + Double.MAX_VALUE);
            return "" + bigValue.add(BigDecimal.ONE);
        }
        catch(Exception ignored) {}
