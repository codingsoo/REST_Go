...
public class ReplaceWithDomainMaximum implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with domain maximum";
    }
    ...
    public String Inject(String valueRepresentation, SchemaBuilder schema)
    {
        try
        {
            ...
            return "" + Integer.parseInt(schema.maximum);
        }
        ...
        try
        {
            ...
            return "" + Float.parseFloat(schema.maximum);
        }
        catch(Exception ignored) {}
        ...
        try
        {
            ...
            return "" + Long.parseLong(schema.maximum);
        }
        catch(Exception ignored) {}
        ...
        try
        {
            ...
            return "" + Double.parseDouble(schema.maximum);
        }
        catch(Exception ignored) {}
