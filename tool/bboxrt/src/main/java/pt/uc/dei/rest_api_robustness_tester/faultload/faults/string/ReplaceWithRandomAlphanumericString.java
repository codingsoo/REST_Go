...
public class ReplaceWithRandomAlphanumericString implements Fault
{
    @Override
    public String FaultName()
    {
        return "Replace with random alphanumeric string of equal length";
    }
    ...
    {
        return Utils.RandomString(Utils.AsciiAlphanumericCharacters(), value.length());
    }
}
